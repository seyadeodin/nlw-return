...
export function ScreenshotButton({ onScreenshotTaken, screenshot }: ScreenshotButtonProps) {
  const [isTakingScreenshot, setIsTakingScreenhot] = useState(false);
  ...
  return(
    <button
      type="button"
      className="p-2 bg-zing-800 rounded-md border-transparent hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
